...
<div>
    <div class="card">
      ...
      <th class="text-center" scope="col">Stock Minimo</th>
  ...
  <tbody>
                        ...
                        <tr>
                            <td class="text-center"> {{$inve->id}}</td>
                            <td class="text-center">{{$inve->stock}}</td>
                            <td class="text-center">{{$inve->stock_minimo}}</td>
                            <td class="text-center">{{$inve->categoria_id}}</td>
